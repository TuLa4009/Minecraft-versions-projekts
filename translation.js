const translations = {
  lv: {
    intro: {
      ...
      versijas: "Versiju saraksts"
    },

    v1_0: {
      title: "1.0 – Adventure Update",
      text: `
      Apraksts: Spēles oficiālā versija, pievienota beigas (fināls) un zāļu pagatavošana.
    ...
    v1_2: {
      ...
      text: `
      Apraksts: Pievienotas biezas džungļi un jauni palīgi.
    ...
    v1_3: {
      ...
      text: `
      Apraksts: Tirdzniecības mehānikas pievienošana.
    ...
    v1_4: {
        ...
        text: `
        Apraksts: Halovīnu atjauninājums ar raganām un jaunu bosu.
    ...
    v1_5: {
        ...
        text: `
        Apraksts: Mehānismu pievienošana un sarkanā akmens attīstība.
    ...
    v1_6: {
        ...
        text: `
        Apraksts: Jājamdzīvnieku un to atribūtu parādīšanās.
    ...
    v1_7: {
        ...
        text: `
        Apraksts: Vērienīgas izmaiņas pasaules ģenerēšanā un daudzu biomu pievienošana.
    ...
    v1_9: {
        ...
        text: `
        Apraksts: Kaujas sistēmas pārstrādāšana un Kraja pasaules paplašināšana.
    ...
    v1_10: {
        ...
        text: `
        Apraksts: Karsto un aukstu biomu atjauninājums.
    ...
    v1_11: {
        ...
        text: `
        Apraksts: Pasaules izpēte un kartogrāfija.
    ...
    v1_12: {
        ...
        text:`
        Apraksts: Krāsu atjauninājums celtniekiem.
    ...
    v1_13: {
        ...
        text: `
        Apraksts: Okeānu pārstrādāšana un jūras dzīvības un ūdens fizikas pievienošana.
    ...
    v1_14: {    
        ...
        text:`
        Apraksts: Iedzīvotāju un to profesiju atjauninājums, iedzīvotāju AI pārstrādāšana un reidu sistēmas izveide.
    ...
    v1_15: {
        ...
        text:`
        Apraksts: Plaša kļūdu labojumu un bišu atjauninājums.
    ...
    v1_17: {
        title: "1.17 - Caves & Cliffs: Part I Update",
        text:`
        Apraksts: Pirmā daļa no alu un klintīm atjauninājuma, pārstrādāta pasaules nejaušā ģenerēšana.
    ...
    v1_19: {
        ...
        text:`
        Apraksts: Mangrovju mežu un drūmā pazemes biomu pievienošana.
    ...
    v1_20: {
        ...
        text:`
        Apraksts: Arheoloģija, bruņu pielāgošana.
    ...
    v1_21: {
        ...
        text:`
        Apraksts: Procedurāli ģenerēti pazemes ar kaujas pārbaudījumiem un vara mehānismiem.
  ...
  ru: {
    ...
    intro: {
      ...
      versijas: "Список версий"
    },

    v1_0: {
      title: "1.0 - Adventure Update",
      text: `
      Описание: Официальный релиз игры, добавление концовки (финала) и зельеварения.
    ...
    v1_2: {
      title: "1.2 - Jungle Update",
      text: `
      Описание: Добавление густых джунглей и новых помощников.
    ...
    v1_3: {
      title: "1.3 - Trade Update",
      text: `
      Описание: Добавление механики торговли.
    ...
    v1_4: {
      title: "1.4 - Pretty Scary Update",
      text: `
      Описание: Хэллоуинское обновление с ведьмами и новым боссом.
    ...
    v1_5: {
      title: "1.5 - Redstone Update",
      text: `
      Описание: Добавление механизмов и развитие красного камня.
    ...
    v1_6: {
      title: "1.6 - Horse Update",
      text: `
      Описание: Появление ездовых животных и атрибутов для них.
    ...
    v1_7: {
      title: "1.7 - The Update that Changed the World",
      text: `
      Описание: Масштабное изменение генерации мира и добавление множества биомов.
    ...
    v1_8: {
      title: "1.8 - Bountiful Update",
      text: `
      Описание: Подводный мир, фермы и механизмы.
    ...
    v1_9: {
      title: "1.9 - Combat Update",
      text: `
      Описание: Переработка боевой системы и Край.
    ...
    v1_10: {
      title: "1.10 - Frostburn Update",
      text: `
      Описание: Горячие и холодные биомы.
    ...
    v1_11: {
      title: "1.11 - Exploration Update",
      text: `
      Описание: Исследование мира и картография.
    ...
    v1_13: {
      title: "1.13 - Aquatic Update",
      text: `
      Описание: Океаны и водная физика.
    ...
    v1_16: {
      title: "1.16 - Nether Update",
      text: `
      Описание: Переработка Нижнего мира.
    ...
    v1_17: {
      title: "1.17 - Caves & Cliffs: Part I Update",
      text: `
      Описание: Пещеры и генерация мира.
    ...
    v1_18: {
      title: "1.18 - Caves & Cliffs: Part II Update",
      text: `
      Описание: Высота мира и генерация.
      Блоки: Нет.
      Мобы: Нет.
      Структуры: Пещеры.`
    },
    ...
    v1_20: {
      title: "1.20 - Trails & Tales Update",
      text: `
      Описание: Археология и кастомизация.
  ...
  intro: {
      ...
      versijas: "Version List"
    },

    v1_0: {
      title: "1.0 - Adventure Update",
      text: `
      Description: Official game release, addition of the ending and potion brewing.
    ...
    v1_2: {
      title: "1.2 - Jungle Update",
      text: `
      Description: Adds dense jungles and new helpers.
    ...
    v1_3: {
      title: "1.3 - Trade Update",
      text: `
      Description: Adds trading mechanics.
    ...
    v1_4: {
      title: "1.4 - Pretty Scary Update",
      text: `
      Description: Halloween update featuring witches and a new boss.
    ...
    v1_5: {
      title: "1.5 - Redstone Update",
      text: `
      Description: Addition of mechanisms and redstone development.
    ...
    v1_6: {
      title: "1.6 - Horse Update",
      text: `
      Description: Introduction of mounts and their equipment.
    ...
    v1_7: {
      title: "1.7 - The Update that Changed the World",
      text: `
      Description: Major changes to world generation and new biomes.
    ...
    v1_8: {
      title: "1.8 - Bountiful Update",
      text: `
      Description: Underwater world, farms and mechanisms update.
    ...
    v1_9: {
      title: "1.9 - Combat Update",
      text: `
      Description: Combat system overhaul and expansion of The End.
    ...
    v1_10: {
      title: "1.10 - Frostburn Update",
      text: `
      Description: Hot and cold biome update.
    ...
    v1_11: {
      title: "1.11 - Exploration Update",
      text: `
      Description: World exploration and cartography.
    ...
    v1_12: {
      title: "1.12 - World of Color Update",
      text: `
      Description: Color update for builders.
    ...
    v1_13: {
      title: "1.13 - Aquatic Update",
      text: `
      Description: Ocean overhaul and aquatic life.
    ...
    v1_14: {
      title: "1.14 - Village & Pillage Update",
      text: `
      Description: Villagers and professions overhaul, AI rework and raid system.
    ...
    v1_15: {
      title: "1.15 - Buzzy Bees Update",
      text: `
      Description: Bug fixes and bees update.
    ...
    v1_17: {
      title: "1.17 - Caves & Cliffs: Part I Update",
      text: `
      Description: First part of caves and cliffs update.
    ...
    v1_18: {
      title: "1.18 - Caves & Cliffs: Part II Update",
      text: `
      Description: World height increase and generation changes.
      Blocks: None.
      Mobs: None.
    ...
    v1_19: {
      title: "1.19 - The Wild Update",
      text: `
      Description: Mangrove forests and deep dark biome.
    ...
    v1_20: {
      title: "1.20 - Trails & Tales Update",
      text: `
      Description: Archaeology and armor customization.
    ...
    v1_21: {
      title: "1.21 - Tricky Trials Update",
      text: `
      Description: Procedural combat dungeons and copper mechanics.
